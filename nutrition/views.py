...
def nutrition(request):
    if request.method == 'POST':
        ...
        api_request = requests.get(
            api_url + query, headers={'X-Api-Key': 'w76UQCFkn0sBY6lVS94SqA==ywIXGjhcfHxHE3dN'})
        try:
            ...
            if api:
                ...
                jog_minutes = (calories / 300) * 60  # Replace 'some_value' with the appropriate number
        ...
        return render(request, 'nutrition/nutrition.html', {'query': 'Enter a valid query'})
